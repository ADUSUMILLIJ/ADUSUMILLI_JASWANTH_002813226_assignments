...
public class WorkAreaPanel_Admin extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        labelVal.setForeground(new java.awt.Color(153, 255, 255));
        labelVal.setText("<Value>");

        labelEnt.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        labelEnt.setForeground(new java.awt.Color(153, 255, 255));
        labelEnt.setText("Enterprise : ");

        buttonOrgMng.setBackground(new java.awt.Color(204, 204, 204));
        buttonOrgMng.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        buttonMngEmp.setBackground(new java.awt.Color(204, 204, 204));
        buttonMngEmp.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        ButtonMngUsr.setBackground(new java.awt.Color(204, 204, 204));
        ButtonMngUsr.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(120, 120, 120)
                        .addComponent(jpanelLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(169, 169, 169)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(labelVal, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addContainerGap()
