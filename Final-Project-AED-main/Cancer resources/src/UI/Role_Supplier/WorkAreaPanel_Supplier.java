...
public class WorkAreaPanel_Supplier extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        buttonprocess.setBackground(new java.awt.Color(204, 204, 204));
        ...
        labelHeader2.setBackground(new java.awt.Color(153, 255, 255));
        labelHeader2.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
        labelHeader2.setForeground(new java.awt.Color(153, 255, 255));
        ...
        tabblesupplier.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medicine Name", "Quantity", "Sender", "Receiver", "Status"
            }
        ) {
