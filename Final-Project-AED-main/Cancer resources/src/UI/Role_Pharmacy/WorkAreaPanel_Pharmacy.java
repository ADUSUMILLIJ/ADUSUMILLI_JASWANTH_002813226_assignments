...
public class WorkAreaPanel_Pharmacy extends javax.swing.JPanel {
     ...
     * regenerated by the Form Editor.dox
     */
    ...
    private void initComponents() {
        ...
        buttonStatus.setBackground(new java.awt.Color(0, 51, 51));
        buttonStatus.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        buttonStatus.setForeground(new java.awt.Color(153, 255, 255));
        ...
        labelSerialNumber.setBackground(new java.awt.Color(0, 51, 51));
        labelSerialNumber.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        labelSerialNumber.setForeground(new java.awt.Color(153, 255, 255));
        ...
        labelMedicineName.setBackground(new java.awt.Color(0, 51, 51));
        labelMedicineName.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        labelMedicineName.setForeground(new java.awt.Color(153, 255, 255));
        ...
        labelAvailableQuantity.setBackground(new java.awt.Color(0, 51, 51));
        labelAvailableQuantity.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        labelAvailableQuantity.setForeground(new java.awt.Color(153, 255, 255));
        ...
        labelReqQuantity.setBackground(new java.awt.Color(0, 51, 51));
        labelReqQuantity.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        labelReqQuantity.setForeground(new java.awt.Color(153, 255, 255));
        ...
        labelReorderLevel.setBackground(new java.awt.Color(0, 51, 51));
        labelReorderLevel.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        labelReorderLevel.setForeground(new java.awt.Color(153, 255, 255));
        ...
        buttonBack.setBackground(new java.awt.Color(0, 51, 51));
        buttonBack.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        buttonBack.setForeground(new java.awt.Color(153, 255, 255));
        ...
        buttonAddMedicine.setBackground(new java.awt.Color(0, 51, 51));
        buttonAddMedicine.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        buttonAddMedicine.setForeground(new java.awt.Color(153, 255, 255));
        ...
        buttonDetails.setBackground(new java.awt.Color(0, 51, 51));
        buttonDetails.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        buttonDetails.setForeground(new java.awt.Color(153, 255, 255));
        ...
        buttonReqs.setBackground(new java.awt.Color(0, 51, 51));
        buttonReqs.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        buttonReqs.setForeground(new java.awt.Color(153, 255, 255));
        ...
        labelDocTbl.setBackground(new java.awt.Color(0, 51, 51));
        labelDocTbl.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        labelDocTbl.setForeground(new java.awt.Color(153, 255, 255));
        ...
        add(scrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 190, 1030, 80));
