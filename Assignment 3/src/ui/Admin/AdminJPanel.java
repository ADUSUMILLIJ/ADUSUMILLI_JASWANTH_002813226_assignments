...
import ui.Admin.ProfDetails.StuDetails.EmployerDetails;
...
public class AdminJPanel extends javax.swing.JPanel {
    ...
    public AdminJPanel(JPanel work, ProfessorDirectory professorList, StudentDirectory studentList, EmployerDirectory employerList) {
        initComponents();
        this.work=work;
    ...
    private void initComponents() {
        ...
        tblAdminE = new javax.swing.JTable();
        txtAdminE = new javax.swing.JTextField();
        btnSearchE = new javax.swing.JButton();
        btnAdminEView = new javax.swing.JButton();
        ...
        tblAdminE.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Employer Name", "Employer ID", "Username", "Password"
            }
        ));
        jScrollPane3.setViewportView(tblAdminE);
        ...
        btnAdminEView.setText("View Employer Details");
        btnAdminEView.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAdminEViewActionPerformed(evt);
            }
        });

        btnEDelete.setText("Delete Account");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtAdminE, javax.swing.GroupLayout.PREFERRED_SIZE, 372, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(21, 21, 21)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtAdminE, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(btnSearchE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnSearchEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchEActionPerformed
        // TODO add your handling code here:
        Employer result = employerList.searchEmployer(txtAdminE.getText());
        if(result == null){
            JOptionPane.showMessageDialog(null, "Account number does not exist","Information", JOptionPane.WARNING_MESSAGE);
        }
        else{
            EmployerDetails panel = new EmployerDetails(work,result,employerList);
            work.add("AdminViewJPanel", panel);
            CardLayout layout = (CardLayout) work.getLayout();
            layout.next(work);
        }
    ...
    private void btnAdminEViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdminEViewActionPerformed
        // TODO add your handling code here:
        int selectedRow = tblAdminE.getSelectedRow();
        if(selectedRow<0){
            JOptionPane.showMessageDialog(null, "please select a row from table to view details","warning",JOptionPane.WARNING_MESSAGE);
        }
        else{
            Employer result = (Employer)tblAdminE.getValueAt(selectedRow,0);
            EmployerDetails panel = new EmployerDetails(work, result, employerList);
            work.add("ViewAccountJPanel", panel);
            CardLayout layout = (CardLayout) work.getLayout();
            layout.next(work);
        }
    }//GEN-LAST:event_btnAdminEViewActionPerformed
    ...
    private void btnEDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEDeleteActionPerformed
        ...
        if(selectedRow >= 0){
            ...
            int dialogResult = JOptionPane.showConfirmDialog(null, "Would you like to delete this account ","Warning", dialogButton);
            if(dialogResult == JOptionPane.YES_OPTION){
                Employer user = (Employer) tblAdminE.getValueAt(selectedRow, 0);
                employerList.deleteEmployer(user);
                populateETable();
            }
    ...
    private javax.swing.JButton btnAdminEView;
    ...
    private javax.swing.JTable tblAdminE;
    private javax.swing.JTable tblAdminP;
    private javax.swing.JTable tblAdminS;
    private javax.swing.JTextField txtAdminE;
...
private void populateSTable() {
    ...
    private void populateETable() {
        DefaultTableModel dtm = (DefaultTableModel) tblAdminE.getModel();
        dtm.setRowCount(0);
        for(Employer user: employerList.getEmployerList()){
            Object[] row = new Object[4];
