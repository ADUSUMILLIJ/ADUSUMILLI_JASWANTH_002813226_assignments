...
public class LoginJPanel extends javax.swing.JPanel {
    ...
    public LoginJPanel(JPanel work, ProfessorDirectory professorList, StudentDirectory studentList, Professor professor, Student student, Course course, CourseDirectory courseList) {
        initComponents();
        this.work=work;
    ...
    private void initComponents() {
        ...
        choicedropdown.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Professor", "Student", "Validator", "Employer" }));
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if("admin".equals(username) && "admin".equals(password)) {
            ...
            AdminJPanel panel = new AdminJPanel(work, professorList, studentList);
            ...
            Professor validatedUser = pvalidateUser(username, password);

            if(validatedUser != null){
            String puserId = validatedUser.getId(); // to get the ID of the authenticated user
        ...
        if(svalidatedUser != null){
            ...
            StuViewDetails userpanel = new StuViewDetails(work,suserId, studentList, student, course, courseList);
