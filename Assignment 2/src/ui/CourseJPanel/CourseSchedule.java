...
public class CourseSchedule extends javax.swing.JPanel {
    ...
    public CourseSchedule(JPanel work, Course course, CourseDirectory courseList, ProfessorDirectory professorList) {
        initComponents();
        this.work=work;
        this.course=course;
    ...
    private void btnAddCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCourseActionPerformed
        ...
        Professor prof = professorList.searchProfessor("");
        String pname = prof.getName();
        String pid = prof.getId();
