...
public class ViewOrderDetailJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewOrderDetailJPanel(JPanel upc, OrderItemClass oi) {
        initComponents();
        userProcessContainer = upc;
        orderItem = oi;
        txtProductName.setText(orderItem.getProd().getProdName());
        txtProductId.setText(Integer.toString(orderItem.getProd().getModelNumb()));
        txtSalesPrice.setText(Double.toString(orderItem.getProd().getRate()));
        txtQuantity.setText(Integer.toString(orderItem.getQuant()));
    ...
    private void initComponents() {
        ...
        backButton1.setFont(new java.awt.Font(".AppleSystemUIFont", 1, 14)); // NOI18N
